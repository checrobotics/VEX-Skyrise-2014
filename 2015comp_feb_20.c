...
#pragma config(Motor,  port7,           CHAIN_MOTOR_1,   tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port5,           CHAIN_MOTOR_2,   tmotorVex393_MC29, openLoop)
...
task skyscraperMove() {
	...
	while (true) {
  		 ...
  		 if (SensorValue(Skyscraper_Up) == 1)
  		  {
  			motor[CHAIN_MOTOR_1] = OFF;
  		  }
  		 else if (SensorValue(Skyscraper_Up) == 1)
  		  {
  			motor[CHAIN_MOTOR_2] = OFF;
  		  }
  		 ...
  		 else if (SensorValue(Skyscraper_Down) == 1)
  		  {
  			motor[CHAIN_MOTOR_2] = OFF;
				...
				{
         motor[CHAIN_MOTOR_1] = FULL_FORWARD;
        }
       else if (vexRT[Btn5U] == 1)
				{
         motor[CHAIN_MOTOR_2] = FULL_FORWARD;
        }
      else if (vexRT[Btn5D] == 1)
      	 {
      	 motor[CHAIN_MOTOR_1] = FULL_REVERSE;
         }
      else if (vexRT[Btn5D] == 1)
      	 {
         motor[CHAIN_MOTOR_2] = FULL_REVERSE;
         }
			else motor[CHAIN_MOTOR_1 && CHAIN_MOTOR_2] = OFF;
